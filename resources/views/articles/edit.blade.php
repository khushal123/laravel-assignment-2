            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="text-center">
                        <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Update Article</h1>
                    </div>
                    <div class="m-7">
                        <form action="{{url('/articles/'.$article->id)}}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="mb-6">
                                ...
                                <textarea type="text" name="body" id="body"
                                    class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500">{{$article->article_body}}</textarea>
                            </div>
                            <div class="mb-6">
